public class SAMStateRepresentation {

	public void update(SAMModel model) {
		// Ajouter la logique pour déterminer ce qui doit être affiché

		// Appeller la méthode render()
		this.render();
	};

	public void render() {
		// Affiche la Vue en utilisant toutes les fonctions suivantes: 
			// draw(Graphics2D g)
			// draw(Graphics2D g, Collection<Figure> c)
